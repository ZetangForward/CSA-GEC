...
save_dir=/data/tzc/model/finetune/gec/gector/stage3/xlnet
...
nohup python ../train.py \
    ...
    --pretrain_folder /data/tzc/model/finetune/gec/gector/stage2/xlnet \
    --pretrain best \
    --special_tokens_fix 0 > ${save_dir}/stage3.log 2>&1 &
