...
save_dir=/data/tzc/model/finetune/gec/gector/stage2/xlnet
...
nohup python ../train.py \
    ...
    --pretrain_folder /data/tzc/model/pretrain/gec/gector/xlnet \
    --pretrain best \
    --special_tokens_fix 0 > ${save_dir}/stage2.log 2>&1 &
